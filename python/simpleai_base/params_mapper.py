...
class ComfyTaskParams:
    ...
    fooo2node = {
        ...
        'prompt': 'CLIPTextEncode:prompt:text;MZ_ChatGLM3:prompt:text;KolorsTextEncode:prompt_negative_prompt:prompt',
        'negative_prompt': 'CLIPTextEncode:negative_prompt:text;MZ_ChatGLM3:negative_prompt:text;KolorsTextEncode:prompt_negative_prompt:negative_prompt',
