...
class ComfyTaskParams:
    ...
    fooo2node = {
        ...
        'prompt': 'CLIPTextEncode:prompt:text;KolorsTextEncode:prompt_negative_prompt:prompt',
        'negative_prompt': 'CLIPTextEncode:negative_prompt:text;KolorsTextEncode:prompt_negative_prompt:negative_prompt',
        'llm_precision': 'DownloadAndLoadChatGLM3:llm_model:precision',
