...
class ComfyTaskParams:
    ...
    fooo2node = {
        ...
        'cfg_scale': 'KSampler:main_sampler:cfgg',
        ...
        'prompt': 'CLIPTextEncode:prompt:text;MZ_ChatGLM3:prompt:text',
        'negative_prompt': 'CLIPTextEncode:negative_prompt:text;MZ_ChatGLM3:negative_prompt:text',
        'llms_model': 'MZ_ChatGLM3Loader:llms_model:chatglm3_checkpoint',
