...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ("seed", "KSampler:main_sampler:seed;TiledKSampler:main_sampler:seed;KolorsSampler:main_sampler:seed;RandomNoise:noise_seed:noise_seed;easy seed:sync_seed:seed;Co_Input_Zho:i2i_overall_input:seed;GeneralInput:GeneralInput:seed"),
    ...
    ("width", "EmptyLatentImage:aspect_ratios_size:width;EmptySD3LatentImage:aspect_ratios_size:width;ImageResize+:resize_input_image:width;KolorsSampler:main_sampler:width;easy int:aspect_ratios_width:value;Co_Input_Zho:i2i_overall_input:width;GeneralInput:GeneralInput:width"),
    ("height", "EmptyLatentImage:aspect_ratios_size:height;EmptySD3LatentImage:aspect_ratios_size:height;ImageResize+:resize_input_image:height;KolorsSampler:main_sampler:height;easy int:aspect_ratios_height:value;Co_Input_Zho:i2i_overall_input:height;GeneralInput:GeneralInput:height"),
    ("prompt", "CLIPTextEncode:prompt:text;MZ_ChatGLM3_V2:prompt:text;KolorsTextEncode:prompt_negative_prompt:prompt;CLIPTextEncodeFlux:prompt:t5xxl;CLIPTextEncodeFlux:prompt:clip_l;Co_Input_Zho:i2i_overall_input:positive;GeneralInput:GeneralInput:prompt"),
    ...
    ("additional_prompt", "easy string:additional_prompt:value;GeneralInput:GeneralInput:additional_prompt"),
    ...
    ("var_number", "easy int:var_number:value;GeneralInput:GeneralInput:var_number"),
