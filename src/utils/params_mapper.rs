...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("scheduler", "KSampler:KSampler:scheduler;KSampler:main_sampler:scheduler;TiledKSampler:main_sampler:scheduler;KolorsSampler:main_sampler:scheduler;BasicScheduler:scheduler_select:scheduler;KSampler Config (rgthree):i2i_KSampler:scheduler"),
    ("denoise", "KSampler:KSampler:denoise;KSampler:main_sampler:denoise;TiledKSampler:main_sampler:denoise;KolorsSampler:main_sampler:denoise_strength;BasicScheduler:scheduler_select:denoise;Co_Input_Zho:i2i_overall_input:denoise;GeneralInput:GeneralInput:denoise"),
    ...
    ("base_model", "CheckpointLoaderSimple:CheckpointLoaderSimple:ckpt_name;CheckpointLoaderSimple:base_model:ckpt_name;UNETLoader:UNETLoader:unet_name;UNETLoader:base_model:unet_name;CheckpointLoaderNF4:base_model:ckpt_name;UnetLoaderGGUF:base_model:unet_name;MZ_KolorsUNETLoaderV2:base_model:unet_name;WanVideoModelLoader:WanVideoModelLoader:model;LoadFramePackModel:LoadFramePackModel:model"),
    ("base_model_dtype", "UNETLoader:UNETLoader:weight_dtype;UNETLoader:base_model:weight_dtype"),
    ("base_model_gguf", "UnetLoaderGGUF:UnetLoaderGGUF:unet_name;UnetLoaderGGUF:base_model_gguf:unet_name"),
    ("base_model2", "CheckpointLoaderSimple:CheckpointLoaderSimple2:ckpt_name;CheckpointLoaderSimple:base_model2:ckpt_name;UNETLoader:UNETLoader2:unet_name;UNETLoader:base_model2:unet_name"),
    ("base_model2_dtype", "UNETLoader:UNETLoader2:weight_dtype;UNETLoader:base_model2:weight_dtype"),
    ...
    ("lora_1", "LoraLoaderModelOnly:LoraLoaderModelOnly:lora_name;LoraLoaderModelOnly:lora_1:lora_name;LoraLoaderModelOnly:lora_speedup:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader:lora_name;WanVideoLoraSelect:WanVideoLoraSelect:lora;FramePackLoraSelect:FramePackLoraSelect:lora"),
    ("lora_1_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly:strength_model;LoraLoaderModelOnly:lora_1:strength_model;LoraLoaderModelOnly:lora_speedup:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect:strength;FramePackLoraSelect:FramePackLoraSelect:strength"),
    ("lora_2", "LoraLoaderModelOnly:LoraLoaderModelOnly1:lora_name;LoraLoaderModelOnly:lora_2:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader1:lora_name;WanVideoLoraSelect:WanVideoLoraSelect1:lora;FramePackLoraSelect:FramePackLoraSelect1:lora"),
    ("lora_2_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly1:strength_model;LoraLoaderModelOnly:lora_2:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader1:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect1:strength;FramePackLoraSelect:FramePackLoraSelect1:strength"),
    ("lora_3", "LoraLoaderModelOnly:LoraLoaderModelOnly2:lora_name;LoraLoaderModelOnly:lora_3:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader2:lora_name;WanVideoLoraSelect:WanVideoLoraSelect2:lora;FramePackLoraSelect:FramePackLoraSelect2:lora"),
    ("lora_3_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly2:strength_model;LoraLoaderModelOnly:lora_3:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader2:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect2:strength;FramePackLoraSelect:FramePackLoraSelect2:strength"),
    ("lora_4", "LoraLoaderModelOnly:LoraLoaderModelOnly3:lora_name;LoraLoaderModelOnly:lora_4:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader3:lora_name;WanVideoLoraSelect:WanVideoLoraSelect3:lora;FramePackLoraSelect:FramePackLoraSelect3:lora"),
    ("lora_4_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly3:strength_model;LoraLoaderModelOnly:lora_4:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader3:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect3:strength;FramePackLoraSelect:FramePackLoraSelect3:strength"),
    ("lora_5", "LoraLoaderModelOnly:LoraLoaderModelOnly4:lora_name;LoraLoaderModelOnly:lora_5:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader4:lora_name;WanVideoLoraSelect:WanVideoLoraSelect4:lora;FramePackLoraSelect:FramePackLoraSelect4:lora"),
    ("lora_5_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly4:strength_model;LoraLoaderModelOnly:lora_5:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader4:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect4:strength;FramePackLoraSelect:FramePackLoraSelect4:strength"),
    ...
    ("input_image", "LoadImage:LoadImage:image;LoadImage:input_image:image"),
