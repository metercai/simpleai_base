...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("base_model", "CheckpointLoaderSimple:CheckpointLoaderSimple:ckpt_name;CheckpointLoaderSimple:base_model:ckpt_name;UNETLoader:UNETLoader:unet_name;UNETLoader:base_model:unet_name;CheckpointLoaderNF4:base_model:ckpt_name;UnetLoaderGGUF:base_model:unet_name;MZ_KolorsUNETLoaderV2:base_model:unet_name"),
    ...
    ("lora_1", "LoraLoaderModelOnly:LoraLoaderModelOnly:lora_name;LoraLoaderModelOnly:lora_1:lora_name;LoraLoaderModelOnly:lora_speedup:lora_name"),
    ("lora_1_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly:strength_model;LoraLoaderModelOnly:lora_1:strength_model;LoraLoaderModelOnly:lora_speedup:strength_model"),
    ("lora_2", "LoraLoaderModelOnly:LoraLoaderModelOnly1:lora_name;LoraLoaderModelOnly:lora_2:lora_name"),
    ("lora_2_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly1:strength_model;LoraLoaderModelOnly:lora_2:strength_model"),
    ("lora_3", "LoraLoaderModelOnly:LoraLoaderModelOnly2:lora_name;LoraLoaderModelOnly:lora_3:lora_name"),
    ("lora_3_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly2:strength_model;LoraLoaderModelOnly:lora_3:strength_model"),
    ("lora_4", "LoraLoaderModelOnly:LoraLoaderModelOnly3:lora_name;LoraLoaderModelOnly:lora_4:lora_name"),
    ("lora_4_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly3:strength_model;LoraLoaderModelOnly:lora_4:strength_model"),
    ("lora_5", "LoraLoaderModelOnly:LoraLoaderModelOnly4:lora_name;LoraLoaderModelOnly:lora_5:lora_name"),
    ("lora_5_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly4:strength_model;LoraLoaderModelOnly:lora_5:strength_model"),
