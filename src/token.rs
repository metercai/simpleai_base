...
impl SimpleAI {
    ...
    pub fn new(
        ...
        let system_name = format!("{}_{}", sys_name, sys_hash_id).chars().take(24).collect::<String>();
        let device_name = format!("{}_{}", host_name, device_hash_id).chars().take(24).collect::<String>();
        let guest_name = format!("guest_{}", sys_hash_id).chars().take(24).collect::<String>();
